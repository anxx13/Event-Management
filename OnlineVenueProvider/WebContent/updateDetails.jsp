...
try
{
  ...
  String cit="update venue_details set vaddress='"+s3+"',cperson='"+s4+"',cpnum='"+s5+"',seating='"+s6+"',dining='"+s7+"',parking='"+s8+"',other='"+s9+"' where vname='"+s2+"'" ;
  c=st.executeUpdate(cit);
  if(c>0){
  %>
  <jsp:forward page="./Update_succes.jsp"></jsp:forward>
  <%
  }
  else
	{%>
	<jsp:forward page="./Update_failure.jsp"></jsp:forward>
	<%
	}
