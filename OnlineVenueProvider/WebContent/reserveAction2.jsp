...
try
{
    ...
    System.out.println(s1);
  	...
  	st2=con.prepareStatement("select * from venue_status where fdate between ? and ?");
	//st2.setString(1,s1);
	st2.setDate(1, sqltDate);
	st2.setDate(2, sqltDate1);
	rs=st2.executeQuery();
  	
  	st3=con.prepareStatement("select * from venue_status where ldate between ? and ?");
	//st3.setString(1,s1);
	...
	st1=con.prepareStatement("insert into venue_status values(?,?,?,?,'booked')");
