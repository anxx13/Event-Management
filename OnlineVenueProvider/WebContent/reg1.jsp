...
<br/>
<div class="articles">
<form action="./registration1.jsp" method="post" name="regform" onsubmit="return validate()">
...
<tr><td align="right"><font color="">Permanent Address::</font></td><td><input type="text" name="peraddress"/></td></tr>
...
<tr><td align="right"><font color="">Role::</font></td><td><input type="text" name="role" value="venue provider" readonly="readonly"/ ></td></tr>
